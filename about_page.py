...
def about_page():
    ...
    st.markdown(
        """
        <div style="text-align: center; padding: 1px; background-color: #f2c855; border-radius: 1px; border: 1.5px solid black; margin-bottom: 20px;">
    ...
    st.markdown(
        """
        <div style="text-align: center; padding: 1px; background-color: #29f2a9; border-radius: 1px; border: 1.5px solid black; margin-bottom: 20px;">
    ...
    st.markdown(
        """
        <div style="text-align: center; padding: 1px; background-color: #3faceb; border-radius: 1px; border: 1.5px solid black; margin-bottom: 20px;">
